...
export const PLACE_CERTIFICATE_CREATE_REQUEST = 'PLACE_CERTIFICATE_CREATE_REQUEST';
export const PLACE_CERTIFICATE_CREATE_SUCCESS = 'PLACE_CERTIFICATE_CREATE_SUCCESS';
export const PLACE_CERTIFICATE_CREATE_FAIL = 'PLACE_CERTIFICATE_CREATE_FAIL';
export const PLACE_CERTIFICATE_CREATE_RESET = 'PLACE_CERTIFICATE_CREATE_RESET';
